...
archived: 2026-06-09
---
> **ARCHIVED 2026-06-09 (implemented-plans sweep)** — original path: `docs/49_list_controls_focus_layout_backlog.md`
...
*When to use: before changing search/sort/filter row controls anywhere — this is the source-of-truth pattern doc. Audience: UI agents.*
