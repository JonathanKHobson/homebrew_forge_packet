...
archived: 2026-06-09
---
> **ARCHIVED 2026-06-09 (implemented-plans sweep)** — original path: `docs/55_ux_consistency_conventions_audit.md`
...
*When to use: before renaming tools/menus or changing app-wide UX conventions. Audience: UI agents. Status: applied; standing guidance.*
