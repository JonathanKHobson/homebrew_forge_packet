...
| 9 | List controls and focused layout cleanup | verified | Maker/Card Browser/Decks/Collections/Binders/Lists | typecheck/build/UX gate/visual QA | `docs/49_list_controls_focus_layout_backlog.md`; `output/playwright/forge-ui-phase-list-controls-focus-layouts/qa-results.json` |
...
| 10 | External research next-version planning | verified | Docs | Claude UXHC merge | `docs/58_external_research_next_version_backlog.md`, `docs/59_next_version_phase_roadmap.md`, `reports/ux-audit/advanced-ux-bug-report.md` |
